...
- Should be able to read skills that are packaged with plugins (note this does not imply that `gent` actually MANAGES those skills)
- Should be able to read skills installed with packages with something like TanStack Intent
